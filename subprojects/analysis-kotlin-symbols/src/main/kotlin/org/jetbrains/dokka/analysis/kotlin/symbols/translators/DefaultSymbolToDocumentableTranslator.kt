...
internal class DokkaSymbolVisitor(
    ...
    fun visitModule(): DModule {
        ...
        val ktFiles = analysisContext.analysisSession.modulesWithFiles[sourceModule]?.filterIsInstance<KtFile>() ?: throw IllegalStateException("No source files for a source module ${sourceModule.moduleName} of source set ${sourceSet.sourceSetID}")
